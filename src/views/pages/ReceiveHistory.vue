...
async function handlePrint(doc) {
    try {
        ...
        if (result.success) {
            ...
            // แปลง receive details เป็นรูปแบบที่ PrintPackingialog ต้องการ
...
<template>
    <div class="flex flex-col gap-6">
        ...
        <!-- Print PackingDialog -->
        <PrintPackingialog v-model:visible="showPrintDialog" :documentData="printDocumentData" :items="printItems" />
