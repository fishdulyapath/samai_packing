...
ไฟล์: `packing_samai/src/components/SafeMegaMenu.vue`
...
1. **`packing_samai/src/components/SafeMegaMenu.vue`** - Component ใหม่ที่มี error handling
2. **`packing_samai/src/views/uikit/MenuDoc.vue`** - อัพเดทใช้ SafeMegaMenu แทน MegaMenu
